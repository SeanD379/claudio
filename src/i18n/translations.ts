...
const translations = {
  ...
  "settings.quickSwitchDesc": { zh: "跳过旁白，直接播放下一首", en: "Skip narration, play next song directly" },
  ...
  "settings.aiNarration": { zh: "AI 旁白", en: "AI Narration" },
  "settings.narrationToggle": { zh: "旁白功能", en: "Narration" },
  "settings.narrationDesc": { zh: "播放歌曲时 AI 会语音介绍歌曲", en: "AI introduces songs during playback" },
