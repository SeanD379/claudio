...
export function DayDetail({
  ...
  const hasContent = (summary && summary.playCount > 0) || historyEvents.length > 0 || isToday(date);
          ...
          >
            {hasContent ? (
              <div className="flex-1 flex flex-col gap-4">
                ...
                />
                <HistoryToday events={historyEvents} month={dateObj.getMonth() + 1} day={dateObj.getDate()} />
              </div>
            ) : (
              <div
